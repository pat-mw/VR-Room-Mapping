...
namespace patmw.XR
{
    ...
    public class CustomAvatar : RealtimeComponent<CustomAvatarModel>
    {
        // Local Player
        [Serializable]
...
#pragma warning restore 0649
        ...
        //*
        public Transform avatarModel { get { return _avatarModel; } }
        public Transform headMesh { get { return _headMesh; } }
...
#pragma warning disable 0649 // Disable variable is never assigned to warning.
        ...
        //*
        [SerializeField] private Transform _avatarModel;
        [SerializeField] private Transform _headMesh;
...
#pragma warning restore 0649
        ...
        void Start()
        {
            ...
            try
            {
                _customAvatarManager = realtime.GetComponent<CustomAvatarManager>();
                _customAvatarManager._RegisterAvatar(realtimeView.ownerIDSelf, this);
            }
        ...
        void OnDestroy()
        {
            ...
            if (_customAvatarManager != null)
                _customAvatarManager._UnregisterAvatar(this);
        ...
        protected override void OnRealtimeModelReplaced(CustomAvatarModel previousModel, CustomAvatarModel currentModel)
        {
        ...
        void SetLocalPlayer(LocalPlayer localPlayer)
        {
            ...
            if (_localPlayer != null)
            {
                ...
                //*
                RealtimeTransform avatarModelRealtimeTransform = _avatarModel != null ? _avatarModel.GetComponent<RealtimeTransform>() : null;
                RealtimeTransform headMeshTransform = _headMesh != null ? _headMesh.GetComponent<RealtimeTransform>() : null;
                ...
                //*
                if (avatarModelRealtimeTransform != null) avatarModelRealtimeTransform.RequestOwnership();
                if (headMeshTransform != null) rightHandRealtimeTransform.RequestOwnership();
            }
        }

        void ActiveStateChanged(CustomAvatarModel model, bool nodeIsActive)
        {
